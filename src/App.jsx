...
function App() {
  return (
    <div className="max-w-md mx-auto min-h-screen bg-stone-100 text-stone-900 pb-24 font-sans selection:bg-red-200">
      
      {/* Cabecera Estilo Fonda */}
      <header className="bg-stone-900 text-white text-center py-8 px-4 rounded-b-3xl shadow-xl mb-6 border-b-4 border-red-600">
      ...
      {/* Botón de Domicilios */}
      <div className="fixed bottom-0 left-0 w-full bg-gradient-to-t from-stone-100 pt-8 pb-4 px-4 flex justify-center z-50">
        <a 
